    ...
    >
      ...
      <Grid item md={6} lg={4}>
          ...
          <Typography variant="caption2">
            ...
            quis nostrud.Lorem ipsum dolor sit amet cons adipisicing elit sed do eiusm tempor
            incididunt ut labor et dolore magna aliqua. Ut enim ad minim veniam,
            quis nostrud.Lorem ipsum dolor sit amet cons adipisicing elit sed do eiusm tempor
            incididunt ut labor et dolore magna aliqua. Ut enim ad minim veniam,
            quis nostrud.
        ...
        <Grid item md={6} lg={2}>
          ...
          <IconButton aria-label="Twitter.com" onClick={() => window.open('https://twitter.com/')}>
          <TwitterIcon sx={{ mr: 1,  fontSize: "30px", color:"white"}} />
          </IconButton>
          <IconButton aria-label="Facebook.com" onClick={() => window.open('https://www.instagram.com/')}>
          <InstagramIcon sx={{ mr: 1,  fontSize: "30px", color:"white"}} />
          </IconButton>
          <IconButton aria-label="Facebook.com" onClick={() => window.open('https://www.pinterest.es/')}>
          <PinterestIcon sx={{ mr: 1,  fontSize: "30px", color:"white"}} />
          </IconButton>
          <IconButton aria-label="Facebook.com" onClick={() => window.open('https://www.youtube.com/')}>
